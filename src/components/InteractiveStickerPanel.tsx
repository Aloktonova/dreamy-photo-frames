...
import { Star, Heart, Smile, Cloud, Sparkles, Sun, Moon, Music, Camera, Flower, ThumbsUp, Leaf, Gift, PartyPopper, Plus, Search, Clock, Folder, ChevronDown, ChevronUp, MessageCircle } from 'lucide-react';
